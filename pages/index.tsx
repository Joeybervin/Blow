...
/* components */
import { Alert, CookiesToast, CurentWeatherHighlight, FilledLineChart, LoadingCard, Navbar, SearchInput } from '@/components';
/* style */
    ...
    <>
      ...
      <main className={`${mPLUSRounded1c.className} min-h-screen`} data-theme={theme}>
        ...
        <div className="flex flex-wrap flex-col sm:flex-row min-h-screen max-w-screen">
            ...
            <div className='flex flex-col justify-items-center max-w-xl mx-auto	mt-5'>
              {
                weather === undefined ?
                  ...
                  <>
                    ...
                    {/* WEATHER IMAGE/ICON | CURRENT TEMPERATURE */}
                    <div className='flex flex-wrap gap-x-5 items-center justify-center p-5 pt-0'>
                      <CldImage priority format={"svg"} className="w-40	sm:w-44" width="200" height="200" src={`Blow/${weather.daily.weathercode[1]}${getWeatherIcon(weather.daily.weathercode[1])}`} alt="<Alt Text>" />
          ...
          {/* RIGHT SIDE : the week weather & charts */}
          <section className="flex-auto bg-gradient-to-r from-primary to-secondary w-full sm:w-96 py-3 px-5">
            ...
            <div className='mt-10 '>
              ...
              <div>
                  ...
                  {weather === undefined ?
                    ...
                    <div className='overflow-x-auto w-full rounded-lg bg-base-100 p-4'>
                      < FilledLineChart
                        ...
                        theme={theme}
                        displayYAxe={false}
                        customPointStyle={weather.hourly.weathercode}
                      />
                      ...
                      <div className='overflow-x-auto w-full min-w-[950px]'>
                        <div className='flex flex-nowrap justify-between space-x-2.5 overflow-x-auto w-full min-w-[950px] h-full'>
                          ...
                          { weather.hourly.weathercode.slice(1 * 24, (1 + 1) * 24).map((element, index) => {
                              return (
                                <CldImage key={index} priority format={"svg"} width="30" height="20" src={`Blow/${weather.daily.weathercode[element]}${getWeatherIcon(weather.daily.weathercode[element])}`} alt="<Alt Text>" />
                              )
                            })
                          }
                        </div>
                        ...
                        <div className='flex flex-nowrap justify-between space-x-2.5 overflow-x-auto w-full min-w-[950px] h-full'>
                          { weather.hourly.temperature_2m.slice(1 * 24, (1 + 1) * 24).map((element, index) => {
                              console.log("index: ", index, " | weathercode: ", element)
                              return (
                ...
                {/* PRECIPITATIONS PROBALITY CHART */}
                <div className='w-full mt-7'>
